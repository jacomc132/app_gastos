...
urlpatterns = [
    ...
    path("<int:ruta_billetera>/modificar_billetera", views.modificar_billetera, name="modificar_billetera"),
    ...
    path("<int:ruta_billetera>/<str:categoria_type>/<int:categoria_id>/modificar_categoria",views.modificar_categoria, name="modificar_categoria"),
    ...
    path("<int:ruta_billetera>/<str:categoria_type>/<int:categoria_id>/<int:ingreso_gasto_id>/modificar_ingreso_gasto",views.modificar_ingreso_gasto, name="modificar_ingreso_gasto")
]